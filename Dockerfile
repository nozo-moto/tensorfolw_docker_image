...
RUN apt update && apt install -y vim graphviz wget libsm6 libxext6 libxrender-dev && python3 -m pip install keras sklearn pydot_ng graphviz nltk pandas tqdm Pillow opencv-python pillow
